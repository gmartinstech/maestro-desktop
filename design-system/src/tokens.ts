// The token values in JS form, mirroring frontend/src/shared/styles/claudeTokens.ts.
// The CSS custom properties in styles/tokens.css are the rendering source of truth; this
// module exists for code that needs a value (canvas drawing, chart series, inline styles).

export interface MaestroTokens {
...
const TRANSITION = 'all 150ms cubic-bezier(0.165, 0.85, 0.45, 1)';

export const lightTokens: MaestroTokens = {
  bg: { page: '#F3F5F8', surface: '#FCFDFE', elevated: '#F8FAFC', secondary: '#E9EEF4', inverse: '#0D1B2A' },
  text: {
    primary: '#0F1D2B',
    secondary: '#33414F',
    tertiary: '#5E6B78',
  ...
  accent: { primary: '#003566', hover: '#0A4C8F', pressed: '#002647' },
  ...
  radius: { sm: 8, md: 8, lg: 8, full: 9999 },
  status: {
    success: '#265B19',
    successBg: '#E9F1DC',
    warning: '#805C1F',
...
export const darkTokens: MaestroTokens = {
  bg: { page: '#0D1621', surface: '#14202D', elevated: '#1C2A38', secondary: '#101A25', inverse: '#F3F5F8' },
  text: {
    primary: '#F3F6FA',
    secondary: '#B8C2CE',
    tertiary: '#8A96A3',
  ...
  // Navy is too dark on a dark surface; a lightened brand-azure carries the accent.
  accent: { primary: '#4A90D9', hover: '#6BA6E2', pressed: '#3B7BC0' },
  brand: { navy: '#003566', gold: '#F5CC00' },
  border: {
