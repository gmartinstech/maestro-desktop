...
const PATHS = {
  ...
  minus: 'M5 12h14',
  palette: 'M12 21a9 9 0 100-18c-4 0-7 3-7 7 0 2 1 3 3 3h2a2 2 0 012 2c0 1-1 2-1 3a3 3 0 003 3zM7.5 10a1 1 0 100-2 1 1 0 000 2zM12 7.5a1 1 0 100-2 1 1 0 000 2zM16.5 10a1 1 0 100-2 1 1 0 000 2z',
  clock: 'M12 21a9 9 0 100-18 9 9 0 000 18zM12 7v5l3.5 2',
  map: 'M9 4l6 2.5L21 4v14l-6 2.5-6-2.5-6 2.5V6z M9 4v14 M15 6.5v14',
} as const;
