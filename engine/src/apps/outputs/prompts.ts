// engine/src/apps/outputs/prompts.ts -- SUB-5, a byte-for-byte port of
// backend/apps/outputs/prompts.py's VIBE_CODE_SYSTEM_PROMPT.

export const VIBE_CODE_SYSTEM_PROMPT = `You are an expert at building self-contained HTML/JS/CSS applications that run in an iframe.
