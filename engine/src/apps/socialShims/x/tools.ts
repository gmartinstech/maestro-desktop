// engine/src/apps/socialShims/x/tools.ts -- SUB-9, the MCP tool surface for X (Twitter), a
// byte-for-byte port of backend/apps/x_mcp_shim/tools.py.
...
export const TOOLS: readonly McpTool[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: OBJ,
      properties: { username: { type: 'string', description: 'Handle, with or without @.' }, count: { type: 'integer', default: 20 }, cursor: { type: 'string' } },
      required: ['username'],
    },
  },
  {
    ...
    inputSchema: { type: OBJ, properties: { target: { type: 'string' }, replies_limit: { type: 'integer', default: 30 } }, required: ['target'] },
  },
  {
    name: 'x_search',
  ...
  },
  {
    ...
    inputSchema: { type: OBJ, properties: { count: { type: 'integer', default: 20 }, cursor: { type: 'string' } } },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      type: OBJ,
      properties: { text: { type: 'string' }, reply_to: { type: 'string', description: 'Tweet URL/id to reply to.' }, quote_id: { type: 'string', description: 'Tweet URL/id to quote.' } },
      required: ['text'],
    },
  },
  {
    ...
    inputSchema: { type: OBJ, properties: { target: { type: 'string' } }, required: ['target'] },
  },
  {
    name: 'x_like',
    description: 'Like a tweet (or unlike with unlike=true).',
    inputSchema: { type: OBJ, properties: { target: { type: 'string' }, unlike: { type: 'boolean', default: false } }, required: ['target'] },
  },
  {
    name: 'x_retweet',
    description: 'Retweet a tweet (or undo with undo=true).',
    inputSchema: { type: OBJ, properties: { target: { type: 'string' }, undo: { type: 'boolean', default: false } }, required: ['target'] },
  },
  {
    name: 'x_bookmark',
    description: 'Bookmark a tweet (or remove with remove=true).',
    inputSchema: { type: OBJ, properties: { target: { type: 'string' }, remove: { type: 'boolean', default: false } }, required: ['target'] },
  },
  {
    name: 'x_follow',
  ...
  },
  {
    ...
    inputSchema: { type: OBJ, properties: { recipient: { type: 'string' }, text: { type: 'string' } }, required: ['recipient', 'text'] },
  },
];
