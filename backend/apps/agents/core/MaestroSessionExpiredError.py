"""The one exception that means "this turn cannot start: the Maestro session is dead".
...
class MaestroSessionExpiredError(Exception):
    ...
    def __init__(self, state: str) -> None:
        ...
        super().__init__(
            f"Maestro session is not authenticated (token {state}); "
