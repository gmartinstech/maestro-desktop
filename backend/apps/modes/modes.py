...
async def list_modes():
    ...
    return {"modes": [m.model_dump() for m in load_all()], "builtin_defaults": builtin_defaults}


@modes.router.get("/{mode_id}")
async def get_mode(mode_id: str):
    return load(mode_id).model_dump()
