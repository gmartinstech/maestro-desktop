...
BUILTIN_TOOLS: list[BuiltinTool] = [
    ...
    BuiltinTool(name="AppAgent", description="Operate one of the user's Maestro-built apps through its native bridge or native input", category="browser_delegation"),
